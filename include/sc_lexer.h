...
/*
  ...
  Support tokens:
    ...
    functions(sin(), cos(), tan(), asin(), acos(), atan(), log(), ln(), f(),
  F()).

  Lexer returns an integer. If there are no errors in the input string,
  0 is returned and lexems's deque created and this deque contains a list of
  tokens, otherwise the error code is returned and lexems contains NULL.
